CREATE DATABASE  IF NOT EXISTS `GeeksHubs` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `GeeksHubs`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: 172.16.11.79    Database: GeeksHubs
-- ------------------------------------------------------
...
CREATE TABLE `Orders` (
  ...
  `DeptoID` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_PersonOrder` (`PersonID`),
  KEY `FK_PersonDep` (`DeptoID`),
  CONSTRAINT `FK_PersonDep` FOREIGN KEY (`DeptoID`) REFERENCES `Departamento` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `articulos` (
  ...
  PRIMARY KEY (`CODIGO`),
  KEY `articulos_ibfk_1` (`FABRICANTE`),
...
CREATE TABLE `empleados` (
  ...
  PRIMARY KEY (`DNI`),
  KEY `empleados_ibfk_1` (`DEPARTAMENTO`),
...
-- Dump completed on 2021-10-15 11:07:21
